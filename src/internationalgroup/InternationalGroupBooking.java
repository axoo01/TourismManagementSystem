...
public class InternationalGroupBooking extends TourBooking {
    private static final double BOOKING_FEE_USD_PER_PERSON = 90.0;
    ...
    public InternationalGroupBooking(String bookingId, String travelerName, LocalDate dateOfBirth,
    ...
    public double calculateBookingFee() throws Exception {
        ...
        double fee = BOOKING_FEE_USD_PER_PERSON * EXCHANGE_RATE * groupSize;
