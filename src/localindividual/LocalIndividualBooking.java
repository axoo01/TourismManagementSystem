...
public class LocalIndividualBooking extends TourBooking {
    private static final double BOOKING_FEE = 20000.0;
    ...
    public LocalIndividualBooking(String bookingId, String travelerName, LocalDate dateOfBirth,
